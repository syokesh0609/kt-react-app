...
//   let docId = location.state.id;
  ...
  let Createrequirement_name = location.state.a.requirement_name;
  let Createrequirement_id = location.state.a.requirement_id;
  let Createpriority = location.state.a.priority;
  let Createaltid = location.state.a.alt_id;
  let Createdescription = location.state.a.description;
        ...
        <div className="container">
          <div className="horizontal-group">
            ...
            <div className="form-group right">
              ...
              <select value={UpdatePriority} onChange={(event) => setTitle2(event.target.value)}>
